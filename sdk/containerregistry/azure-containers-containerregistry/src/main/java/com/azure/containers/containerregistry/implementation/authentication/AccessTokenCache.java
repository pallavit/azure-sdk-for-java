...
import com.azure.containers.containerregistry.implementation.credential.AcrTokenCredential;
...
public class AccessTokenCache {
    ...
    private final AcrTokenCredential tokenCredential;
    private AcrTokenRequestContext tokenRequestContext;
    private final Predicate<AccessToken> shouldRefresh;
    private final ClientLogger logger = new ClientLogger(com.azure.core.experimental.implementation.AccessTokenCacheImpl.class);
     ...
     */
    public AccessTokenCache(AcrTokenCredential tokenCredential) {
     ...
     */
    public Mono<AccessToken> getToken(AcrTokenRequestContext tokenRequestContext) {
    ...
    private Supplier<Mono<? extends AccessToken>> retrieveToken(AcrTokenRequestContext tokenRequestContext) {
        return () -> {
            try {
    ...
    private boolean checkIfWeShouldForceRefresh(AcrTokenRequestContext tokenRequestContext) {
        // TODO: Think of when to force refresh the cache.
        return false;
    }
