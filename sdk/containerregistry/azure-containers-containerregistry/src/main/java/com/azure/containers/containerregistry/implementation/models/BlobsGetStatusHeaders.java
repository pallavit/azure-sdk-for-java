...
/** The BlobsGetStatusHeaders model. */
@JacksonXmlRootElement(localName = "null")
@Fluent
public final class BlobsGetStatusHeaders {
    /*
     ...
     * @return the BlobsGetStatusHeaders object itself.
     */
    public BlobsGetStatusHeaders setDockerUploadUUID(String dockerUploadUUID) {
     ...
     * @return the BlobsGetStatusHeaders object itself.
     */
    public BlobsGetStatusHeaders setRange(String range) {
        this.range = range;
        return this;
    }
}
