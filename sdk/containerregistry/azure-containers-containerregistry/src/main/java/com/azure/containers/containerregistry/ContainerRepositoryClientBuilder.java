...
public class ContainerRepositoryClientBuilder {
     ...
     * @return the ContainerRepositoryClientBuilder.
     */
    public ContainerRepositoryClientBuilder httpPipeline(HttpPipeline httpPipeline) {
     ...
     * @return the ContainerRepositoryClientBuilder.
     */
    public ContainerRepositoryClientBuilder serializerAdapter(SerializerAdapter serializerAdapter) {
