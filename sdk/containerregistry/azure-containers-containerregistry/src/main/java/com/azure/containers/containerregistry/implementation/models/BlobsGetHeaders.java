...
/** The BlobsGetHeaders model. */
@JacksonXmlRootElement(localName = "null")
@Fluent
public final class BlobsGetHeaders {
    /*
     ...
     */
    public BlobsGetHeaders setContentLength(Long contentLength) {
     ...
     * @return the BlobsGetHeaders object itself.
     */
    public BlobsGetHeaders setDockerContentDigest(String dockerContentDigest) {
     ...
     * @return the BlobsGetHeaders object itself.
     */
    public BlobsGetHeaders setLocation(String location) {
