...
/** The BlobsUploadHeaders model. */
@Fluent
public final class BlobsUploadHeaders {
    /*
     ...
     * @return the BlobsUploadHeaders object itself.
     */
    public BlobsUploadHeaders setDockerUploadUUID(String dockerUploadUUID) {
     ...
     * @return the BlobsUploadHeaders object itself.
     */
    public BlobsUploadHeaders setRange(String range) {
        this.range = range;
        return this;
    }
     ...
     * @return the BlobsUploadHeaders object itself.
     */
    public BlobsUploadHeaders setLocation(String location) {
