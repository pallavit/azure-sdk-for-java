...
/** The ChangeableAttributes model. */
@JacksonXmlRootElement(localName = "ChangeableAttributes")
@Fluent
public final class ChangeableAttributes {
    /*
     * Delete enabled
     */
     ...
     * @return the ChangeableAttributes object itself.
     */
    public ChangeableAttributes setDeleteEnabled(Boolean deleteEnabled) {
     ...
     * @return the ChangeableAttributes object itself.
     */
    public ChangeableAttributes setWriteEnabled(Boolean writeEnabled) {
     ...
     * @return the ChangeableAttributes object itself.
     */
    public ChangeableAttributes setListEnabled(Boolean listEnabled) {
     ...
     * @return the ChangeableAttributes object itself.
     */
    public ChangeableAttributes setReadEnabled(Boolean readEnabled) {
