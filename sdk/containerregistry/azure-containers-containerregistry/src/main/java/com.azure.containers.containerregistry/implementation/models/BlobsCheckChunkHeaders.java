...
/** The BlobsCheckChunkHeaders model. */
@Fluent
public final class BlobsCheckChunkHeaders {
    /*
     ...
     * @return the BlobsCheckChunkHeaders object itself.
     */
    public BlobsCheckChunkHeaders setContentRange(String contentRange) {
     ...
     * @return the BlobsCheckChunkHeaders object itself.
     */
    public BlobsCheckChunkHeaders setContentLength(Long contentLength) {
