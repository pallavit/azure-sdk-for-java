...
/** The BlobsStartUploadHeaders model. */
@Fluent
public final class BlobsStartUploadHeaders {
    /*
     ...
     * @return the BlobsStartUploadHeaders object itself.
     */
    public BlobsStartUploadHeaders setDockerUploadUUID(String dockerUploadUUID) {
     ...
     * @return the BlobsStartUploadHeaders object itself.
     */
    public BlobsStartUploadHeaders setRange(String range) {
        this.range = range;
        return this;
    }
     ...
     * @return the BlobsStartUploadHeaders object itself.
     */
    public BlobsStartUploadHeaders setLocation(String location) {
