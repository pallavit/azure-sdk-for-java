...
/** The BlobsGetChunkHeaders model. */
@Fluent
public final class BlobsGetChunkHeaders {
    /*
     ...
     * @return the BlobsGetChunkHeaders object itself.
     */
    public BlobsGetChunkHeaders setContentRange(String contentRange) {
     ...
     * @return the BlobsGetChunkHeaders object itself.
     */
    public BlobsGetChunkHeaders setContentLength(Long contentLength) {
