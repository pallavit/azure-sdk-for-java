...
/** The BlobsEndUploadHeaders model. */
@Fluent
public final class BlobsEndUploadHeaders {
    /*
     * The Range property.
     */
     ...
     * @return the BlobsEndUploadHeaders object itself.
     */
    public BlobsEndUploadHeaders setRange(String range) {
        this.range = range;
        return this;
    }
     ...
     * @return the BlobsEndUploadHeaders object itself.
     */
    public BlobsEndUploadHeaders setLocation(String location) {
     ...
     * @return the BlobsEndUploadHeaders object itself.
     */
    public BlobsEndUploadHeaders setDockerContentDigest(String dockerContentDigest) {
