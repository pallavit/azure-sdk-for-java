...
/** The ManifestsCreateHeaders model. */
@Fluent
public final class ManifestsCreateHeaders {
    /*
     ...
     * @return the ManifestsCreateHeaders object itself.
     */
    public ManifestsCreateHeaders setContentLength(Long contentLength) {
     ...
     * @return the ManifestsCreateHeaders object itself.
     */
    public ManifestsCreateHeaders setDockerContentDigest(String dockerContentDigest) {
     ...
     * @return the ManifestsCreateHeaders object itself.
     */
    public ManifestsCreateHeaders setLocation(String location) {
